    ...
    util.request(API.QRCordUrl, {
      ...
      wx.getImageInfo({
        ...
        success: function (res2) {
          ...
          ctx.fillText("place："+(that.data.campus==0?"肇庆":"广州")+"校区" + that.data.place, 155, pageHeight)
          ...
          ctx.fillText((that.data.contactType == 0 ? "wechat：" : "qq：") + that.data.contactNum, 155, pageHeight + 20)
