...
Page({
  ...
  onLoad: function() {
    if (app.globalData.user == null) {
      ...
      var weixin = app.globalData.user.weChat
      var qq = app.globalData.user.qq
      if (weixin != null && weixin != "" && weixin != "null") {
        that.setData({
          contactNum: weixin
        })
      } else if (qq != null && qq != "" && qq != "null") {
        that.setData({
          contactNum: qq,
          accountIndex: 1
        })
        ...
        wx.showActionSheet({
          ...
          success: res1 => {
            ...
            util.request(API.AddModelUrl, {
              ...
              imgSrc: JSON.stringify(that.data.imgRealPath)
            }, "POST", {
